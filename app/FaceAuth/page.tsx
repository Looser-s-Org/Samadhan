...
import { StatusMessage } from '@/app/Face_Components/StatusMessage';
import { SecurityAlert } from '@/app/Face_Components/SecurityAlert';
import { ActionToggle } from '@/app/Face_Components/ActionToggle';
import RegistrationPanel from '@/app/Face_Components/RegistrationPanel';
import AuthenticationPanel from '@/app/Face_Components/AuthenticationPanel';
import InfoSection from '@/app/Face_Components/InfoSection';
import { enhanceImage as enhanceImageService } from '@/app/api/ImageEnhancementService';
import { blandApiService} from '@/app/api/BlandApiService';
import { UserData, EnhancedImageResult, AuthFailureLog } from '@/app/api/types';
  ...
  const authenticateUser = async () => {
    ...
    try {
      ...
      if (averageDistance < 0.55) {
        ...
        setIsAuthenticating(false);
        return true;
      } else if (averageDistance > 0.55 && averageDistance < 0.57) {
        // Partial match with relaxed threshold
        updateStatus(`Partial match detected. Proceeding with liveness check...`, 'warning');
        setIsAuthenticating(false);
        return true;
      } else {
      ...
      <div className="face-auth-container">
        ...
        {!showAuthentication ? (
          ...
          <AuthenticationPanel
            ...
            onAuthenticationComplete={handleSuccessfulAuthentication} // Pass the callback function here
          />
        )}
