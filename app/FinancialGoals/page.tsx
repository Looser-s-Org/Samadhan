...
image: 'https://public.readdy.ai/ai/img_res/d7ff4a606edd9f32ce7333431486d138.jpg'
},
{
id: 2,
...
image: 'https://public.readdy.ai/ai/img_res/eba32d19a361fff32904ab46f32d2cab.jpg'
},
{
id: 3,
...
image: 'https://public.readdy.ai/ai/img_res/72e9b40cef7d6c7ca36ad2ab684aa82e.jpg'
}
]);
...
yAxis: {
type: 'category',
data: ['Entertainment', 'Utilities', 'Food', 'Transportation', 'Housing'],
axisLabel: {
color: '#fff'
}
},
...
const retirementChart = echarts.init(document.getElementById('retirement-chart'));
...
<img src="https://public.readdy.ai/ai/img_res/aa254986b68142823a41d4d787f71588.jpg" alt="Logo" className="h-8" />
<nav className="space-x-6">
<button className="text-gray-300 hover:text-white">Overview</button>
<button className="text-gray-300 hover:text-white">Savings</button>
<button className="text-gray-300 hover:text-white">Expenses</button>
</nav>
</div>
...
className={`px-6 py-2 rounded-lg ${activeTab === 'all' ? 'bg-blue-600' : 'bg-gray-800'} !rounded-button`}
>
All Goals
</button>
<button
onClick={() => setActiveTab('active')}
className={`px-6 py-2 rounded-lg ${activeTab === 'active' ? 'bg-blue-600' : 'bg-gray-800'} !rounded-button`}
>
Active
</button>
<button
onClick={() => setActiveTab('completed')}
className={`px-6 py-2 rounded-lg ${activeTab === 'completed' ? 'bg-blue-600' : 'bg-gray-800'} !rounded-button`}
>
Completed
</button>
</div>
...
<img src={goal.image} alt={goal.title} className="w-full h-full object-cover object-top" />
</div>
<div className="p-6">
...
<span>Monthly:</span>
<span className="ml-2">₹{goal.monthly.toLocaleString()}</span>
</div>
...
<div className="bg-gray-800 rounded-xl p-6">
<h3 className="text-xl font-semibold mb-4">Monthly Savings Analysis</h3>
...
<p className="text-sm text-gray-400 mt-2">Next payment in 12 days</p>
</div>
<div className="bg-gray-800 rounded-xl p-6">
<h4 className="text-lg font-semibold mb-2">Monthly Expenses</h4>
<p className="text-3xl font-bold text-red-500">₹85,000</p>
<p className="text-sm text-gray-400 mt-2">-5.2% from last month</p>
</div>
<div className="bg-gray-800 rounded-xl p-6">
<h4 className="text-lg font-semibold mb-2">Investment Returns</h4>
...
<h3 className="text-xl font-semibold mb-4">Contribute to {selectedGoal}</h3>
